    ...
    return (React.createElement(Component, __assign({ ref: Component === defaultProps.as ? component : undefined }, other, { className: className }),
        React.createElement(React.Fragment, null,
            React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.title, component: TitleLabel, editorId: 'k-scheduler-editor-title', className: 'k-form-label' }, localization.toLanguageString(editorEventTitle, messages[editorEventTitle])),
            ...
            React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.start, component: StartLabel, editorId: "k-scheduler-editor-start", className: 'k-form-label' }, localization.toLanguageString(editorEventStart, messages[editorEventStart])),
                React.createElement("div", { className: "k-form-field-wrap" },
            ...
            React.createElement(FieldWrapper, null,
                ...
                React.createElement("div", { className: "k-form-field-wrap" },
                    ...
                    React.createElement(StartTimezoneCheckedLabel, { className: 'k-checkbox-label', editorId: 'k-scheduler-editor-set-start-timezone' }, localization.toLanguageString(editorEventTimeZone, messages[editorEventTimeZone])))),
            startZoneChecked && (React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.start, component: StartTimezoneLabel, className: 'k-form-label' }, localization.toLanguageString(editorEventStartTimeZone, messages[editorEventStartTimeZone])),
                React.createElement("div", { className: "k-form-field-wrap" },
            ...
            React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.end, component: EndLabel, editorId: "k-scheduler-editor-end", className: 'k-form-label' }, localization.toLanguageString(editorEventEnd, messages[editorEventEnd])),
                React.createElement("div", { className: "k-form-field-wrap" },
            ...
            startZoneChecked && (React.createElement(FieldWrapper, null,
                ...
                React.createElement(EndTimezoneCheckedLabel, { editorId: 'k-scheduler-editor-set-end-timezone', className: 'k-form-label' }, localization.toLanguageString(editorEventSeparateTimeZones, messages[editorEventSeparateTimeZones])))),
            endZoneChecked && (React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.endTimezone, component: EndTimezoneLabel, className: 'k-form-label' }, localization.toLanguageString(editorEventEndTimeZone, messages[editorEventEndTimeZone])),
                React.createElement("div", { className: "k-form-field-wrap" },
            ...
            React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.isAllDay, component: Label, className: 'k-form-label' }),
                React.createElement("div", { className: "k-form-field-wrap" },
            ...
            React.createElement(FieldWrapper, null,
                React.createElement(Field, { name: fields.description, component: DescriptionLabel, className: 'k-form-label' }, localization.toLanguageString(editorEventDescription, messages[editorEventDescription])),
                React.createElement("div", { className: "k-form-field-wrap" },
                    React.createElement(Field, { component: DescriptionEditor, name: fields.description, rows: 1, id: 'k-event-description' }),
            ...
            (resources || []).map(function (resource) { return (React.createElement(FieldWrapper, { key: resource.field },
                React.createElement(Field, { name: resource.field, component: ResourceLabel, className: 'k-form-label' }),
                React.createElement(Label, { className: 'k-form-label' }, resource.name),
