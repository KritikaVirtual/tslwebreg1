...
import { caretAltLeftIcon, caretAltRightIcon, clockIcon } from '@progress/kendo-svg-icons';
...
export var Scheduler = React.forwardRef(function (props, ref) {
    ...
    var className = React.useMemo(function () { return classNames({ 'k-rtl': props.rtl !== undefined ? props.rtl : dir === 'rtl' }, 'k-widget k-scheduler k-floatwrap k-pos-relative', props.className); }, [props.className, props.rtl, dir]);
    ...
    , { 
        ...
        React.createElement("div", { ref: element, id: props.id, style: style, className: className, tabIndex: props.tabIndex, 
            ...
            React.createElement(Header, null,
                React.createElement(Navigation, null,
                    React.createElement(ButtonGroup, { className: "k-scheduler-navigation" },
                        ...
                        React.createElement(Button, { role: "button", tabIndex: -1, icon: dir === 'rtl' ? 'caret-alt-right' : 'caret-alt-left', svgIcon: dir === 'rtl' ? caretAltRightIcon : caretAltLeftIcon, title: previousText, "aria-label": previousText, onClick: handlePrevClick }),
                        React.createElement(Button, { role: "button", tabIndex: -1, icon: dir === 'rtl' ? 'caret-alt-left' : 'caret-alt-right', svgIcon: dir === 'rtl' ? caretAltLeftIcon : caretAltRightIcon, title: nextText, "aria-label": nextText, onClick: handleNextClick }))),
            ...
            React.createElement(Footer, null, (slotDuration && slotDuration < (24 * 60)) && (React.createElement(BusinessHours, null,
                React.createElement(Button, { tabIndex: -1, onClick: handleShowWorkHoursClick, icon: "clock", svgIcon: clockIcon }, localization.toLanguageString(showWorkHours
                    ? showFullDay
