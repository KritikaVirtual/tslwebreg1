...
export var SchedulerForm = React.forwardRef(function (props, ref) {
    ...
    return canUseDOM
        ? ReactDOM.createPortal((React.createElement(Form, __assign({ initialValues: props.dataItem, onSubmit: handleSubmit, validator: formValidator, render: function (renderProps) { return (React.createElement(Dialog, { title: editorTitleMessage, minWidth: 400, onClose: handleClose, className: "k-scheduler-edit-dialog" },
                React.createElement(SchedulerFormEditor, __assign({}, renderProps, { as: Editor })),
                React.createElement(DialogActionsBar, { layout: 'start' },
                    React.createElement(Button, { themeColor: 'primary', disabled: !renderProps.allowSubmit, onClick: renderProps.onSubmit, icon: "save", svgIcon: saveIcon }, editSaveMessage),
                    React.createElement(Button, { onClick: handleCancel, icon: "cancel", svgIcon: cancelIcon }, editCancelMessage)))); } }, other))), document && document.body)
        : null;
});
var defaultProps = {
    dialog: KendoDialog,
