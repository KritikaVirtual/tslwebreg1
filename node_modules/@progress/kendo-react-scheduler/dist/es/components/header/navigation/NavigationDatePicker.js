...
export var NavigationDatePicker = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Button, { ref: button, onFocus: onFocus, onBlur: onBlur, fillMode: 'flat', className: 'k-nav-current', icon: "calendar", svgIcon: calendarIcon, "aria-live": "polite", tabIndex: -1, onClick: handleClick }, media === 'desktop'
            ? text
            : shortText),
