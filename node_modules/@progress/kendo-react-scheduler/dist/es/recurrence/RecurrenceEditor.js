...
export var RecurrenceEditor = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(FieldWrapper, null,
            React.createElement(Label, { className: 'k-form-label' }, localization.toLanguageString(recurrenceEditorRepeat, messages[recurrenceEditorRepeat])),
        ...
        (frequency !== 'never') && (React.createElement(FieldWrapper, null,
            React.createElement(Label, { editorId: "interval-editor", className: 'k-form-label' }, localizeMessage(capitalize(frequency) + 'RepeatEvery')),
            React.createElement("div", { className: "k-form-field-wrap" },
                React.createElement(NumericTextBox, { min: 1, step: 1, defaultValue: 1, value: rrule.interval, onChange: handleIntervalChange, id: "interval-editor", className: 'k-recur-interval' }),
                React.createElement(React.Fragment, null, "\u00A0"),
                React.createElement(Label, { editorId: "interval-editor", className: 'k-form-label' }, localizeMessage(capitalize(frequency) + 'Interval'))))),
        (frequency === 'weekly') && (React.createElement(FieldWrapper, null,
            React.createElement(Label, { className: 'k-form-label' }, localizeMessage(recurrenceEditorWeeklyRepeatOn, true)),
            React.createElement("div", { className: "k-form-field-wrap" },
                React.createElement(RecurrenceRepeatOnWeekEditor, { data: weekDays, value: (rrule.byWeekDay || []).map(function (_a) {
                        var day = _a.day;
                        return day;
                    }), onChange: handleWeekDaysChange })))),
        (frequency === 'monthly') && (React.createElement(FieldWrapper, null,
            React.createElement(Label, { key: "recurrence-repeat-on-monthly-label", className: 'k-form-label' }, localizeMessage(recurrenceEditorMonthlyRepeatOn, true)),
            React.createElement("div", { className: "k-form-field-wrap" },
        ...
        (frequency === 'yearly') && (React.createElement(FieldWrapper, null,
                ...
                React.createElement(RadioGroup, { value: repeatOnRule, item: RadioGroupListItem, onChange: handleRepeatOnRuleChange, className: "k-reset", data: [
                        ...
                        },
                        {
                            ...
                            children: [
                                ...
                                React.createElement("span", { key: "yearly-weekday-of-label" }, localizeMessage(recurrenceEditorYearlyOf, true)),
        ...
        (frequency !== 'never') && (React.createElement("div", { className: "k-scheduler-recurrence-end-rule-editor" },
            React.createElement(FieldWrapper, null,
                React.createElement(Label, { className: 'k-form-label' }, localizeMessage(recurrenceEditorEndLabel, true)),
                React.createElement("div", { className: "k-form-field-wrap" },
                    React.createElement(RadioGroup, { item: RadioGroupListItem, value: endRule, onChange: handleEndRuleChange, data: [
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    React.createElement(NumericTextBox, { key: "endrule-after-editor", id: "k-endrule-after", className: 'k-recur-count', min: 1, width: '70px', value: endRule === 'count' ? rrule.count : defaultCount, onChange: handleCountChange, disabled: endRule !== 'count' }),
