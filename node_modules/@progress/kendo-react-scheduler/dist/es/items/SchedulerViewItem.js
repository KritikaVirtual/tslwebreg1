...
import { IconWrap, useDir } from '@progress/kendo-react-common';
import { caretAltLeftIcon, arrowRotateCwIcon, arrowsNoRepeatIcon, caretAltRightIcon } from '@progress/kendo-svg-icons';
import { useEditable, useRowSync } from '../hooks';
var ITEMS_SPACING = 1;
...
export var SchedulerViewItem = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(Item, __assign({}, itemProps, { _ref: item, _maxSiblingsPerSlot: maxSiblingsPerSlot, itemRef: item, style: __assign({ visibility: visible ? undefined : 'hidden', display: display ? undefined : 'none' }, props.style) }),
        (!props.resizeHint) && React.createElement("span", { className: "k-event-actions" },
            props.tail &&
                React.createElement(IconWrap, { name: dir === 'rtl' ? 'caret-alt-right' : 'caret-alt-left', icon: dir === 'rtl' ? caretAltRightIcon : caretAltLeftIcon }),
            (props.isRecurring && !props.isException) && React.createElement(IconWrap, { name: "arrow-rotate-cw", icon: arrowRotateCwIcon }),
            (!props.isRecurring && props.isException) && React.createElement(IconWrap, { name: "arrows-no-repeat", icon: arrowsNoRepeatIcon })),
