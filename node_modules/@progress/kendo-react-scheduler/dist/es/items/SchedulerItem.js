...
import { classNames, useDraggable, IconWrap, useDir } from '@progress/kendo-react-common';
import { useInternationalization, useLocalization } from '@progress/kendo-react-intl';
import { xIcon, caretAltRightIcon, caretAltLeftIcon } from '@progress/kendo-svg-icons';
import { messages, deleteTitle } from '../messages';
import { useEditable, useSchedulerItem } from '../hooks';
import { formatEventTime } from '../utils';
/**
 * Represents the default `item` component rendered by the [KendoReact Scheduler component]({% slug overview_scheduler %}).
 */
export var SchedulerItem = React.forwardRef(function (props, ref) {
    var 
    // Focus
    ...
    var _a = useSchedulerItem(props, ref), item = _a.item, element = _a.element;
    ...
    var eventLabel = React.useMemo(function () { return "".concat(formatEventTime(intl, props.zonedStart, props.zonedEnd, props.isAllDay), ", ").concat(props.title); }, [intl, props.isAllDay, props.title, props.zonedEnd, props.zonedStart]);
    ...
    return (React.createElement("div", { ref: element, id: props.id, style: style, tabIndex: tabIndex, className: className, 
        // Aria
        role: 'button', "aria-label": eventLabel, "aria-selected": props.selected || undefined, 
        // Focus
        ...
        (!props.resizeHint) && React.createElement("span", { className: "k-event-actions" },
            ...
            props.head &&
                React.createElement(IconWrap, { name: dir === 'rtl' ? 'caret-alt-left' : 'caret-alt-right', icon: dir === 'rtl' ? caretAltLeftIcon : caretAltRightIcon })),
