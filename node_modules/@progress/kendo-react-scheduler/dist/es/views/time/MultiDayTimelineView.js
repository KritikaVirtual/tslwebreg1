    ...
    var body = (React.createElement(SchedulerResourceIteratorContext.Consumer, null, function (_a) {
        ...
        return (React.createElement("div", { className: "k-scheduler-row" }, ranges.map(function (_, rangeIndex) {
            return (slots
                ...
                var utcZonedDayStart = ZonedDate.fromUTCDate(toUTCDateTime(slot.zonedStart), timezone);
                var isWorkDayUTCStart = isInDaysRange(utcZonedDayStart.getDay(), workWeekStart, workWeekEnd);
                return (React.createElement(EditSlot, __assign({ key: "".concat(slot.start.getTime(), ":").concat(slot.group.index), slot: props.slot, viewSlot: props.viewSlot }, slot, { form: props.form, onDataAction: props.onDataAction, isWorkHour: isInTimeRange(slot.zonedStart, workDayStart, workDayEnd), isWorkDay: isWorkDayUTCStart, col: orientation === 'horizontal'
