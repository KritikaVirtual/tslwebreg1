...
var AgendaView = function (props) {
    ...
    var dir = (0, kendo_react_common_1.useDir)(element);
                                ...
                                ? slot.items.map(function (item, itemIndex) { return (React.createElement("div", { className: "k-scheduler-row", key: itemIndex },
                                    React.createElement("div", { className: "k-scheduler-cell k-scheduler-timecolumn" },
                                        React.createElement("div", null,
                                            ...
                                            item.head &&
                                                React.createElement(kendo_react_common_1.IconWrap, { name: dir === 'rtl' ? 'caret-alt-left' : 'caret-alt-right', icon: dir === 'rtl' ? kendo_svg_icons_1.caretAltLeftIcon : kendo_svg_icons_1.caretAltRightIcon }))),
