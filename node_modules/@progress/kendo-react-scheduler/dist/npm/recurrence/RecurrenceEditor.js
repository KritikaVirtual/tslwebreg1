...
var RecurrenceEditor = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(kendo_react_form_1.FieldWrapper, null,
            React.createElement(kendo_react_labels_1.Label, { className: 'k-form-label' }, localization.toLanguageString(messages_1.recurrenceEditorRepeat, messages_1.messages[messages_1.recurrenceEditorRepeat])),
        ...
        (frequency !== 'never') && (React.createElement(kendo_react_form_1.FieldWrapper, null,
            React.createElement(kendo_react_labels_1.Label, { editorId: "interval-editor", className: 'k-form-label' }, localizeMessage((0, common_1.capitalize)(frequency) + 'RepeatEvery')),
            React.createElement("div", { className: "k-form-field-wrap" },
                React.createElement(kendo_react_inputs_1.NumericTextBox, { min: 1, step: 1, defaultValue: 1, value: rrule.interval, onChange: handleIntervalChange, id: "interval-editor", className: 'k-recur-interval' }),
                React.createElement(React.Fragment, null, "\u00A0"),
                React.createElement(kendo_react_labels_1.Label, { editorId: "interval-editor", className: 'k-form-label' }, localizeMessage((0, common_1.capitalize)(frequency) + 'Interval'))))),
        (frequency === 'weekly') && (React.createElement(kendo_react_form_1.FieldWrapper, null,
            React.createElement(kendo_react_labels_1.Label, { className: 'k-form-label' }, localizeMessage(messages_1.recurrenceEditorWeeklyRepeatOn, true)),
            React.createElement("div", { className: "k-form-field-wrap" },
        ...
        (frequency === 'monthly') && (React.createElement(kendo_react_form_1.FieldWrapper, null,
            React.createElement(kendo_react_labels_1.Label, { key: "recurrence-repeat-on-monthly-label", className: 'k-form-label' }, localizeMessage(messages_1.recurrenceEditorMonthlyRepeatOn, true)),
            React.createElement("div", { className: "k-form-field-wrap" },
        ...
        (frequency === 'yearly') && (React.createElement(kendo_react_form_1.FieldWrapper, null,
                ...
                React.createElement(kendo_react_inputs_1.RadioGroup, { value: repeatOnRule, item: RadioGroupListItem, onChange: handleRepeatOnRuleChange, className: "k-reset", data: [
                        ...
                        },
                        {
                            ...
                            children: [
                                ...
                                React.createElement("span", { key: "yearly-weekday-of-label" }, localizeMessage(messages_1.recurrenceEditorYearlyOf, true)),
        ...
        (frequency !== 'never') && (React.createElement("div", { className: "k-scheduler-recurrence-end-rule-editor" },
            React.createElement(kendo_react_form_1.FieldWrapper, null,
                React.createElement(kendo_react_labels_1.Label, { className: 'k-form-label' }, localizeMessage(messages_1.recurrenceEditorEndLabel, true)),
                React.createElement("div", { className: "k-form-field-wrap" },
                    React.createElement(kendo_react_inputs_1.RadioGroup, { item: RadioGroupListItem, value: endRule, onChange: handleEndRuleChange, data: [
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    React.createElement(kendo_react_inputs_1.NumericTextBox, { key: "endrule-after-editor", id: "k-endrule-after", className: 'k-recur-count', min: 1, width: '70px', value: endRule === 'count' ? rrule.count : defaultCount, onChange: handleCountChange, disabled: endRule !== 'count' }),
...
var RadioGroupListItem = function (props) {
    return (React.createElement("li", __assign({}, props), props.children));
};
