...
exports.Scheduler = React.forwardRef(function (props, ref) {
    ...
    var className = React.useMemo(function () { return (0, kendo_react_common_1.classNames)({ 'k-rtl': props.rtl !== undefined ? props.rtl : dir === 'rtl' }, 'k-widget k-scheduler k-floatwrap k-pos-relative', props.className); }, [props.className, props.rtl, dir]);
    ...
    , { 
        ...
        React.createElement("div", { ref: element, id: props.id, style: style, className: className, tabIndex: props.tabIndex, 
            ...
            React.createElement(Header, null,
                React.createElement(Navigation, null,
                    React.createElement(kendo_react_buttons_1.ButtonGroup, { className: "k-scheduler-navigation" },
                        ...
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: dir === 'rtl' ? 'caret-alt-right' : 'caret-alt-left', svgIcon: dir === 'rtl' ? kendo_svg_icons_1.caretAltRightIcon : kendo_svg_icons_1.caretAltLeftIcon, title: previousText, "aria-label": previousText, onClick: handlePrevClick }),
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: dir === 'rtl' ? 'caret-alt-left' : 'caret-alt-right', svgIcon: dir === 'rtl' ? kendo_svg_icons_1.caretAltLeftIcon : kendo_svg_icons_1.caretAltRightIcon, title: nextText, "aria-label": nextText, onClick: handleNextClick }))),
            ...
            React.createElement(Footer, null, (slotDuration && slotDuration < (24 * 60)) && (React.createElement(BussinessHours_1.BusinessHours, null,
                React.createElement(kendo_react_buttons_1.Button, { tabIndex: -1, onClick: handleShowWorkHoursClick, icon: "clock", svgIcon: kendo_svg_icons_1.clockIcon }, localization.toLanguageString(showWorkHours
