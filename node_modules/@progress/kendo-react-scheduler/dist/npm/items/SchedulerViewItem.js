...
exports.SchedulerViewItem = void 0;
 ...
 */
exports.SchedulerViewItem = React.forwardRef(function (props, ref) {
    ...
    var dir = (0, kendo_react_common_1.useDir)(scheduler);
    ...
    var position = function () {
        ...
        rect.width = (props.vertical
            ...
            : ((rect.width * slots.length) - (constants_1.BORDER_WIDTH)));
        rect.height = props.vertical
            ? ((rect.height * slots.length) - (constants_1.BORDER_WIDTH))
    ...
    var schedulerElement = item.current && item.current.element
    ...
    return (React.createElement(Item, __assign({}, itemProps, { _ref: item, _maxSiblingsPerSlot: maxSiblingsPerSlot, itemRef: item, style: __assign({ visibility: visible ? undefined : 'hidden', display: display ? undefined : 'none' }, props.style) }),
        (!props.resizeHint) && React.createElement("span", { className: "k-event-actions" },
            props.tail &&
                React.createElement(kendo_react_common_1.IconWrap, { name: dir === 'rtl' ? 'caret-alt-right' : 'caret-alt-left', icon: dir === 'rtl' ? kendo_svg_icons_1.caretAltRightIcon : kendo_svg_icons_1.caretAltLeftIcon }),
            (props.isRecurring && !props.isException) && React.createElement(kendo_react_common_1.IconWrap, { name: "arrow-rotate-cw", icon: kendo_svg_icons_1.arrowRotateCwIcon }),
            (!props.isRecurring && props.isException) && React.createElement(kendo_react_common_1.IconWrap, { name: "arrows-no-repeat", icon: kendo_svg_icons_1.arrowsNoRepeatIcon })),
...
exports.SchedulerViewItem.defaultProps = defaultProps;
exports.SchedulerViewItem.displayName = 'KendoReactSchedulerViewItem';
