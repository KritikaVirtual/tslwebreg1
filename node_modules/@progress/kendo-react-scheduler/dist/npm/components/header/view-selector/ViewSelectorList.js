...
exports.ViewSelectorList = React.forwardRef(function () {
    ...
    return (React.createElement("div", { className: (0, kendo_react_common_1.classNames)('k-toolbar-button-group k-button-group k-button-group-solid', {
            'k-scheduler-views': media === 'desktop',
            'k-scheduler-tools': media === 'mobile'
        }), role: 'group', ref: element },
        ...
        (media === 'desktop') && (React.createElement(React.Fragment, null, views.map(function (view) { return (React.createElement(ViewSelectorItem_1.ViewSelectorItem, { key: view.props.name, view: view.props })); })))));
});
