...
exports.SchedulerForm = React.forwardRef(function (props, ref) {
    ...
    return kendo_react_common_1.canUseDOM
        ? ReactDOM.createPortal((React.createElement(kendo_react_form_1.Form, __assign({ initialValues: props.dataItem, onSubmit: handleSubmit, validator: formValidator, render: function (renderProps) { return (React.createElement(Dialog, { title: editorTitleMessage, minWidth: 400, onClose: handleClose, className: "k-scheduler-edit-dialog" },
                ...
                React.createElement(kendo_react_dialogs_1.DialogActionsBar, { layout: 'start' },
                    React.createElement(kendo_react_buttons_1.Button, { themeColor: 'primary', disabled: !renderProps.allowSubmit, onClick: renderProps.onSubmit, icon: "save", svgIcon: kendo_svg_icons_1.saveIcon }, editSaveMessage),
                    React.createElement(kendo_react_buttons_1.Button, { onClick: handleCancel, icon: "cancel", svgIcon: kendo_svg_icons_1.cancelIcon }, editCancelMessage)))); } }, other))), document && document.body)
        : null;
});
var defaultProps = {
