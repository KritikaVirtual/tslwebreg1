...
function readColumns(elements, oldColumns, idInfo, depth) {
    ...
    elements.forEach(function (columnProps, index) {
        ...
        columns.push(Object.assign({ depth: depth }, GridColumn_1.GridColumn.defaultProps, (children.length) ? { cell: function () { return null; }, filterCell: function () { return null; } } : {}, oldColumn ? { width: oldColumn.width, orderIndex: oldColumn.orderIndex } : {}, columnProps, {
            id: columnProps.id ? columnProps.id : kendo_react_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(idInfo.prevId++), idInfo.idPrefix, 'column'),
        ...
        fields.forEach(function (field) {
            if (field !== expandField) {
                columns.push(Object.assign({
                    id: kendo_react_data_tools_1.tableKeyboardNavigationTools.generateNavigatableId("".concat(idInfo.prevId++), idInfo.idPrefix, 'column'),
                    declarationIndex: -1,
                    parentIndex: -1,
                    depth: 0,
                    colSpan: 0,
...
var sanitizeColumns = function (columns) {
    ...
    return columns.map(function (column) {
        ...
        return children.length ? __assign({ children: (0, exports.sanitizeColumns)(children) }, props) : props;
    });
};
