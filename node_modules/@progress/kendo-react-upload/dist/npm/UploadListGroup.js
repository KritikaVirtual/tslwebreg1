...
exports.UploadListGroup = void 0;
...
var UploadListGroup = /** @class */ (function (_super) {
    ...
    UploadListGroup.prototype.render = function () {
        ...
        var liClassName = (0, kendo_react_common_1.classNames)('k-file', utils_1.default.filesHaveValidationErrors(files) ? 'k-file-error k-file-invalid' : '', firstFile.status === UploadFileStatus_1.UploadFileStatus.UploadFailed || firstFile.status === UploadFileStatus_1.UploadFileStatus.RemoveFailed ?
            'k-file-error' : '', firstFile.status === UploadFileStatus_1.UploadFileStatus.Uploading ? 'k-file-progress' : '', isFileSuccess ? 'k-file-success' : '', navigationIndex === index ? 'k-focus' : '');
        var itemOptions = {
            async: async,
            disabled: disabled,
            onCancel: onCancel,
