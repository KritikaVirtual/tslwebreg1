...
exports.UploadListMultiItem = void 0;
...
var UploadListMultiItem = /** @class */ (function (_super) {
        ...
        _this.mapFiles = function () {
            ...
            return files.map(function (file) {
                return (React.createElement("span", { key: file.name, className: 'k-file-info' },
                    ...
                    utils_1.default.fileHasValidationErrors(file) ?
                        (React.createElement("span", { className: 'k-file-validation-message' }, _this.getFileValidationMessage(file))) :
                        (React.createElement("span", { key: "".concat(file.name, "-size"), className: 'k-file-size' }, utils_1.default.getTotalFilesSizeMessage([file])))));
            });
        };
        /**
         * @hidden
    ...
    UploadListMultiItem.prototype.render = function () {
        ...
        var _b = utils_1.default.getFileStatus(files), isUploaded = _b[1], isUploadFailed = _b[2], isUploadValidationFailed = _b[3];
        var localizationService = (0, kendo_react_intl_1.provideLocalizationService)(this);
        ...
        return (React.createElement("div", { className: (0, kendo_react_common_1.classNames)('k-file-multiple') },
            !isUploadValidationFailed && !isUploaded && !isUploadFailed &&
                React.createElement(kendo_react_progressbars_1.ProgressBar, { value: progress || 0 }),
            React.createElement("span", { className: 'k-file-icon-wrapper' },
                React.createElement(kendo_react_common_1.IconWrap, { className: 'k-file-icon', name: 'copy', icon: kendo_svg_icons_1.copyIcon, size: 'xxlarge' })),
            React.createElement("span", { className: "k-multiple-files-wrapper" },
                this.mapFiles(),
                !isUploadFailed ?
                    (progress !== 100 ?
                        (React.createElement("span", { className: 'k-file-summary' }, "".concat(totalMessage, ": ").concat(files.length, " ").concat(filesMessage, ", ").concat(utils_1.default.getTotalFilesSizeMessage(files)))) :
            ...
            React.createElement(UploadListActionButton_1.UploadListActionButton, __assign({ uid: files[0].uid, status: files[0].status, progress: progress }, others))));
    };
    return UploadListMultiItem;
}(React.Component));
exports.UploadListMultiItem = UploadListMultiItem;
(0, kendo_react_intl_1.registerForLocalization)(UploadListMultiItem);
