...
var TreeListRow_1 = require("./TreeListRow");
var kendo_svg_icons_1 = require("@progress/kendo-svg-icons");
var RowDragClue = function (props) {
    return props.visible && kendo_react_common_1.canUseDOM ?
        ReactDOM.createPortal((React.createElement("div", { className: "k-header k-drag-clue", style: {
            ...
            React.createElement(kendo_react_common_1.IconWrap, { className: (0, kendo_react_common_1.classNames)('k-drag-status'), name: props.allowDrop ? 'plus' : 'cancel', icon: props.allowDrop ? kendo_svg_icons_1.plusIcon : kendo_svg_icons_1.cancelIcon }),
...
var TreeListDraggableRow = /** @class */ (function (_super) {
    ...
    TreeListDraggableRow.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(kendo_react_common_1.Draggable, { ref: this.draggable, onPress: this.onPress, onDrag: this.onDrag, onRelease: this.onRelease },
                React.createElement(TreeListRow_1.TreeListRow, __assign({}, this.props))),
            React.createElement(RowDragClue, __assign({}, clueProps))));
    };
    return TreeListDraggableRow;
}(React.Component));
exports.TreeListDraggableRow = TreeListDraggableRow;
