        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "k-filter-toolbar" },
                React.createElement(kendo_react_buttons_1.Toolbar, { keyboardNavigation: false, role: "toolbar", ariaLabel: ariaLabel },
                    ...
                    React.createElement(kendo_react_buttons_1.Button, { className: 'k-toolbar-button', title: locService.toLanguageString(messages_1.filterAddExpression, messages_1.messages[messages_1.filterAddExpression]), icon: "filter-add-expression", svgIcon: kendo_svg_icons_1.filterAddExpressionIcon, type: "button", onClick: this.onAddExpression }, locService.toLanguageString(messages_1.filterAddExpression, messages_1.messages[messages_1.filterAddExpression])),
                    React.createElement(kendo_react_buttons_1.Button, { className: 'k-toolbar-button', title: locService.toLanguageString(messages_1.filterAddGroup, messages_1.messages[messages_1.filterAddGroup]), icon: "filter-add-group", svgIcon: kendo_svg_icons_1.filterAddGroupIcon, type: "button", onClick: this.onAddGroup }, locService.toLanguageString(messages_1.filterAddGroup, messages_1.messages[messages_1.filterAddGroup])),
