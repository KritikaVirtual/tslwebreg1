...
var Expression = /** @class */ (function (_super) {
    ...
    Expression.prototype.render = function () {
        ...
        var _a = this.props, fields = _a.fields, filter = _a.filter, _b = _a.ariaLabel, ariaLabel = _b === void 0 ? locService.toLanguageString(messages_1.filterExpressionAriaLabel, messages_1.messages[messages_1.filterExpressionAriaLabel]) : _b;
        ...
        return (React.createElement("div", { className: "k-filter-toolbar" },
            React.createElement(kendo_react_buttons_1.Toolbar, { keyboardNavigation: false, role: "toolbar", ariaLabel: ariaLabel },
                ...
                React.createElement(kendo_react_buttons_1.Button, { className: 'k-toolbar-button', title: locService.toLanguageString(messages_1.filterClose, messages_1.messages[messages_1.filterClose]), icon: "x", svgIcon: kendo_svg_icons_1.xIcon, fillMode: "flat", type: "button", onClick: this.onFilterRemove }))));
    };
