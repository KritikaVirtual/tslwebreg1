...
var PagerPageSizes = /** @class */ (function (_super) {
    ...
    PagerPageSizes.prototype.render = function () {
        ...
        return (React.createElement("span", { className: "k-pager-sizes" },
            ...
            React.createElement("span", null, (0, kendo_react_intl_1.provideLocalizationService)(this).toLanguageString(itemPerPageMessage.messageKey, itemPerPageMessage.defaultMessage))));
    };
