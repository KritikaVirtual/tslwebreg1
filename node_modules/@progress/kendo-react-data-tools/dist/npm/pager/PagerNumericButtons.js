...
var PagerNumericButtons = /** @class */ (function (_super) {
    ...
    PagerNumericButtons.prototype.renderDots = function (page, ariaLabel) {
        var _this = this;
        return (React.createElement(kendo_react_buttons_1.Button, { fillMode: 'flat', themeColor: 'primary', size: this.props.size, rounded: null, role: "button", "aria-label": ariaLabel, onClick: function (e) { return _this.handlePageChange(e, page); } }, dots));
    };
