...
var IFrameIntegrationContext = React__default["default"].createContext(null);
var useIFrameIntegrationContext = function () {
    var context = React__default["default"].useContext(IFrameIntegrationContext);
    if (!context) {
...
var IFrameIntegration = function (_a) {
    ...
    var _b = React__default["default"].useState(false), popupIsShown = _b[0], setPopupIsShown = _b[1];
    var popupFormRef = React__default["default"].useRef(null);
...
var IFrameContainer = function (_a) {
    ...
    var _c = React__default["default"].useState(0), offsetWidth = _c[0], setOffsetWidth = _c[1];
    var _d = React__default["default"].useState(0), offsetHeight = _d[0], setOffsetHeight = _d[1];
    // React.useEffect(() => {
    //   if (popupIsShown) {
    //     debugger;
    //   }
