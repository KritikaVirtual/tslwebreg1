                    ...
                    <div className="table-responsive">
                      ...
                      >
                        ...
                        <table className="table table-striped table-bordered">
                          ...
                          <tbody>
                            {props.registrantSessionsData !== undefined &&
                            props.registrantSessionsData.length > 0 ? (
                              callPageRecords(props.registrantSessionsData)
                            ) : (
