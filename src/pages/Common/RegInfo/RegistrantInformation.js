...
export function RegistrantInformation(props) {
  ...
  }, [props.registrantData, props.regTypesData]);
  ...
  // console.log('fieldsChecked',fieldsChecked)
                          ...
                          <tbody>
                            ...
                            {/* <tr className="questionsContent">
                                                        ...
                                                        <tr className="questionsContent">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control" placeholder='Enter Text question' />
                                                            </td>
                                                        </tr>
