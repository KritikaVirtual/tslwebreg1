                ...
                <div class="form-content">
                    <div class="row">
                        <div class="col-md-12 form-heading ">
                            <h4>{props.eventsData?  props.eventsData.sStep6Desc : ''}</h4>
                        </div>
                        <div className="textHeader">
                            {props.eventsData ? <div dangerouslySetInnerHTML={{ __html: props.eventsData.sStep6Text }} />  : ''}
                        </div>
                        ...
                        <div class="stepsTab stepsform-wrap">
                            ...
                            {/* <div class="col-md-12 col-xs-12">
                                <Input type="radio" name="terms" value="1" onChange={(event)=>_handlePaymentType(event)} />
                        ...
                        <div className="textFooter">
                            {props.eventsData ? <div dangerouslySetInnerHTML={{ __html: props.eventsData.sStep6TextBottom }} /> : ''}
                        </div>
