...
export function EventForm(props) {
        ...
        useEffect(()=>{
           if(props.fetchEventData!==undefined){
              setFields(props.fetchEventData);
           }
        ...
        const validateRegistration = (fields) => {
                ...
                if (!fields["lBadgeReportID"] || fields["lBadgeReportID"] === "") {
                        formIsValid = false;
                        errors["lBadgeReportID"] = "*Please select your Badge Layout.";
                }

                if (fields["bUniqueEmailsForAddReg"] === "") {
                        formIsValid = false;
        ...
        const _handleSubmit = (event) =>{
                ...
                if (_validateForm()) {
                        if(props.userId && props.eventId){
                                ...
                                postData.dtCloseSite = moment(fields.dtCloseSite).format("YYYY-MM-DD")
                                postData.dtEnd = moment(fields.dtEnd).format("YYYY-MM-DD")
                                postData.dtStart = moment(fields.dtStart).format("YYYY-MM-DD")
                                props.updateEventInfo(postData)
                        }
                }
        }
        return (
                        ...
                        <div className="form-content">
                                ...
                                <div className="row">
                                        <div className="col-md-12 col-xs-12">
                                                ...
                                                <input type="text" className="form-control" onChange={(e)=>_handleChange(e)} value={ fields.sName ? fields.sName : ''} name="sName" placeholder="Event Name"/>
                                                {errors.sName ? (<div className="errorMsg text-danger">{errors.sName}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Event Location</label><br/>
                                                <input type="text" className="form-control" value={ fields.sLocation ? fields.sLocation : ''} onChange={(e)=>_handleChange(e)} name="sLocation" placeholder="Event Location"/>
                                                {errors.sLocation ? (<div className="errorMsg text-danger">{errors.sLocation}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Start Date</label><br/>
                                                <input type="date" className="form-control" value={ fields.dtStart ? moment(fields.dtStart).format("YYYY-MM-DD") : '' }   onChange={(e)=>_handleChange(e)} name="dtStart" placeholder="Start Date"/>
                                                {errors.dtStart ? (<div className="errorMsg text-danger">{errors.dtStart}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>End Date</label><br/>
                                                <input type="date" className="form-control" value={ fields.dtEnd ? moment(fields.dtEnd).format("YYYY-MM-DD") : '' } onChange={(e)=>_handleChange(e)} name="dtEnd" placeholder="End Date"/>
                                                {errors.dtEnd ? (<div className="errorMsg text-danger">{errors.dtEnd}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Status</label><br/>
                                                <select name="sStatus" id="" className="form-control" value={ fields.sStatus ? fields.sStatus : ''} onChange={(e) => _handleChange(e)}>
                                        ...
                                        <div className="col-md-12 col-xs-12">
                                                <label>Event Contact</label><br/>
                                                <input type="text" className="form-control" value={ fields.sEventContactName ? fields.sEventContactName : ''} onChange={(e)=>_handleChange(e)} name="sEventContactName" placeholder="Event Contact"/>
                                                {errors.sEventContactName ? (<div className="errorMsg text-danger">{errors.sEventContactName}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Event Email</label><br/>
                                                <input type="text" className="form-control"  value={ fields.sEventContactEmail ? fields.sEventContactEmail : ''} onChange={(e)=>_handleChange(e)} name="sEventContactEmail" placeholder="Event Email"/>
                                                {errors.sEventContactEmail ? (<div className="errorMsg text-danger">{errors.sEventContactEmail}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Close site date</label><br/>
                                                <input type="date" className="form-control"  value={ fields.dtCloseSite ? moment(fields.dtCloseSite).format("YYYY-MM-DD") : ''}  onChange={(e)=>_handleChange(e)} name="dtCloseSite" placeholder="Close site date"/>
                                                {errors.dtCloseSite ? (<div className="errorMsg text-danger">{errors.dtCloseSite}</div>) : ("")}
                                        </div>
                                        <div className="col-md-12 col-xs-12">
                                                <label>Default Badge Layout</label><br/>
                                                <select name="lBadgeReportID" onChange={(e)=>_handleChange(e)} value={ fields.lBadgeReportID ? fields.lBadgeReportID : ''} className="form-control" placeholder="Accunt Type"  >
                                        ...
                                        <div className="col-md-12 col-xs-12">
                                                ...
                                                <input type="radio" name="bUniqueEmailsForAddReg" value="1"  checked={ (fields.bUniqueEmailsForAddReg && fields.bUniqueEmailsForAddReg==1) ? true : false } onChange={(e)=>_handleChange(e)}/>
                                                <label className="radio-label">Enable</label><br/>
                                                <input type="radio" name="bUniqueEmailsForAddReg" value="0" checked={ (fields.bUniqueEmailsForAddReg==0) ? true : false } onChange={(e)=>_handleChange(e)}/>
                                        ...
                                        <div className="col-md-12 col-xs-12">
                                                ...
                                                <input type="text" onChange={(e)=>_handleChange(e)} className="form-control" value={ fields.sAccessCode ? fields.sAccessCode : ''}  name="sAccessCode" placeholder="" disabled/>
                                                {/* {errors.sAccessCode ? (<div className="errorMsg text-danger">{errors.sAccessCode}</div>) : ("")} */}
                                        </div>

                                        <div className="col-md-12 col-xs-12">
                                                <label>Group Registration Link</label>
                                                <Link className="templateLink" to={"/template21"+(props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '')}>{API_URL+'template21'+ (props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '') }</Link>
                                        </div>

                                        <div className="col-md-12 col-xs-12">
                                                <label>Main Registration Link</label>
                                                <Link className="templateLink" to={"/template1start"+(props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '')}>{API_URL+'template1start'+ (props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '') }</Link>
                                        </div>

                                        <div className="col-md-12 col-xs-12">
                                                <label>Attendees Registration Link</label>
                                                <Link className="templateLink" to={"/template1"+(props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '')}>{API_URL+'template1'+ (props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '') }</Link>
                                        </div>

                                        <div className="col-md-12 col-xs-12">
                                                <label>Exhibitors Registration Link</label>
                                                <Link className="templateLink" to={"/template1"+(props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '')}>{API_URL+'template1'+ (props.userId ? '?userId='+props.userId : '') + (props.eventId ? '&eventId='+props.eventId : '') }</Link>
                                        </div>
                                </div>
                                <div>
