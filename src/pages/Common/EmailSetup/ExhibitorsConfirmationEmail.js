...
const ExhibitorsConfirmationEmail = (props) => {

  const [exhibitorsConfirmationEmail,setExhibitorsConfirmationEmail] = useState("")

  const exhibitorsConfirmationEmailResult = (data) => {
    setExhibitorsConfirmationEmail(data)
  };

  useEffect(()=>{
    if(exhibitorsConfirmationEmail){
        let result = {}
        result['mConfirmationEmailTextExh'] = exhibitorsConfirmationEmail
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Exhibitors Confirmation Email"
                  editorCategory={"ExhibitorsConfirmationEmail"}
                  editorType={"ExhibitorsConfirmationEmail"}
                  backData={(data) => exhibitorsConfirmationEmailResult(data)}
                  fetchData={
                    props.exhibitorsConfirmationEmail
                      ? props.exhibitorsConfirmationEmail
                      : ""
                  }
                />
...
export default ExhibitorsConfirmationEmail;
