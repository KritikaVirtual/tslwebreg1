...
const InviteEmailRegistrant = (props) => {

  const [inviteEmailRegistrant,setInviteEmailRegistrant] = useState("")

  const inviteEmailRegistrantResult = (data) => {
    setInviteEmailRegistrant(data)
  };

  useEffect(()=>{
    if(inviteEmailRegistrant){
        let result = {}
        result['mInviteEmailText'] = inviteEmailRegistrant
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the email invite"
                  editorCategory={"inviteEmailRegistrant"}
                  editorType={"inviteEmailRegistrant"}
                  backData={(data) => inviteEmailRegistrantResult(data)}
                  fetchData={
                    props.inviteEmailRegistrant
                      ? props.inviteEmailRegistrant
                      : ""
                  }
                />
...
export default InviteEmailRegistrant;
