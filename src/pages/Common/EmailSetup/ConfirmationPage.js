...
const ConfirmationPage = (props) => {
  ...
  const confirmationPageResult = (data) => {
  ...
  useEffect(() => {
    if (confirmationPage) {
      let result = {};
      result["mConfirmationPageText"] = confirmationPage;
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Confirmation page"
                  editorCategory={"confirmationPage"}
                  editorType={"confirmationPage"}
                  backData={(data) => confirmationPageResult(data)}
                  fetchData={
                    props.confirmationPage ? props.confirmationPage : ""
                  }
                />
              </div>
            </div>
