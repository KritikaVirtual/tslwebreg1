export const USER_ACTION_TYPE = {
  ...
  GET_GUEST_ADDITIONAL_INFORMATION_BY_ID_ERROR:
    "GET_GUEST_ADDITIONAL_INFORMATION_BY_ID_ERROR",
  GET_ANSWERS_REGISTRANT_PENDING:
    "GET_ANSWERS_REGISTRANT_PENDING",
  GET_ANSWERS_REGISTRANT_SUCESS:
    "GET_ANSWERS_REGISTRANT_SUCESS",
  GET_ANSWERS_REGISTRANT_ERROR:
    "GET_ANSWERS_REGISTRANT_ERROR",
  GET_REGISTRANTS_SESSIONS_PENDING:
    "GET_REGISTRANTS_SESSIONS_PENDING",
  GET_REGISTRANTS_SESSIONS_SUCESS:
    "GET_REGISTRANTS_SESSIONS_SUCESS",
  GET_REGISTRANTS_SESSIONS_ERROR:
    "GET_REGISTRANTS_SESSIONS_ERROR",
  GET_SESSIONS_CONFIG_PENDING:
    "GET_SESSIONS_CONFIG_PENDING",
  GET_SESSIONS_CONFIG_SUCESS:
    "GET_SESSIONS_CONFIG_SUCESS",
  GET_SESSIONS_CONFIG_ERROR:
    "GET_SESSIONS_CONFIG_ERROR",
  GET_REGISTRANT_SESSIONS_BY_ID_PENDING:
    "GET_REGISTRANT_SESSIONS_BY_ID_PENDING",
  GET_REGISTRANT_SESSIONS_BY_ID_SUCESS:
    "GET_REGISTRANT_SESSIONS_BY_ID_SUCESS",
  GET_REGISTRANT_SESSIONS_BY_ID_ERROR:
    "GET_REGISTRANT_SESSIONS_BY_ID_ERROR",
  GET_REG_PAYMENTS_PENDING:
    "GET_REG_PAYMENTS_PENDING",
  GET_REG_PAYMENTS_SUCESS:
    "GET_REG_PAYMENTS_SUCESS",
  GET_REG_PAYMENTS_ERROR:
    "GET_REG_PAYMENTS_ERROR",
  GET_REG_PAYMENTS_BY_ID_PENDING:
    "GET_REG_PAYMENTS_BY_ID_PENDING",
  GET_REG_PAYMENTS_BY_ID_SUCESS:
    "GET_REG_PAYMENTS_BY_ID_SUCESS",
  GET_REG_PAYMENTS_BY_ID_ERROR:
    "GET_REG_PAYMENTS_BY_ID_ERROR",
  GET_REG_AMOUNT_PENDING:
    "GET_REG_AMOUNT_PENDING",
  GET_REG_AMOUNT_SUCESS:
    "GET_REG_AMOUNT_SUCESS",
  GET_REG_AMOUNT_ERROR:
    "GET_REG_AMOUNT_ERROR",
  GET_STRIPE_DETAILS_PENDING:
    "GET_STRIPE_DETAILS_PENDING",
  GET_STRIPE_DETAILS_SUCESS:
    "GET_STRIPE_DETAILS_SUCESS",
  GET_STRIPE_DETAILS_ERROR:
    "GET_STRIPE_DETAILS_ERROR",
  GET_REGISTRANT_PENDING:
    "GET_REGISTRANT_PENDING",
  GET_REGISTRANT_SUCESS:
    "GET_REGISTRANT_SUCESS",
  GET_REGISTRANT_ERROR:
    "GET_REGISTRANT_ERROR",
  GET_REG_TYPE_AMOUNT_PENDING:
  "GET_REG_TYPE_AMOUNT_PENDING",
  GET_REG_TYPE_AMOUNT_SUCESS:
    "GET_REG_TYPE_AMOUNT_SUCESS",
  GET_REG_TYPE_AMOUNT_ERROR:
    "GET_REG_TYPE_AMOUNT_ERROR",
  RESET_REG_DATA:
    "RESET_REG_DATA",
  GET_PAYMENT_DETAILS_PENDING:
    "GET_PAYMENT_DETAILS_PENDING",
  GET_PAYMENT_DETAILS_SUCESS:
    "GET_PAYMENT_DETAILS_SUCESS",
  ...
  RESET_SESSION_PRICE:
    "RESET_SESSION_PRICE",
  RESET_REGISTRANTS_SESSIONS:
    "RESET_REGISTRANTS_SESSIONS",
  GET_GUEST_REGISTRANT_SUCESS:
    "GET_GUEST_REGISTRANT_SUCESS",
  GET_GUEST_REGISTRANT_ERROR:
    "GET_GUEST_REGISTRANT_ERROR",
  GET_GUEST_REGISTRANT_PENDING:
    "GET_GUEST_REGISTRANT_PENDING",
  GET_SESSION_PRICE_SUCESS:
    "GET_SESSION_PRICE_SUCESS",
  GET_SESSION_PRICE_ERROR:
    "GET_SESSION_PRICE_ERROR",
  GET_SESSION_PRICE_PENDING:
    "GET_SESSION_PRICE_PENDING",
  GET_EVENT_HEADER_FOOTER_SUCESS:
    "GET_EVENT_HEADER_FOOTER_SUCESS",
  GET_EVENT_HEADER_FOOTER_ERROR:
    "GET_EVENT_HEADER_FOOTER_ERROR",
  GET_EVENT_HEADER_FOOTER_PENDING:
    "GET_EVENT_HEADER_FOOTER_PENDING",
  GET_REG_TYPES_TEMPLATE1_SUCESS:
    "GET_REG_TYPES_TEMPLATE1_SUCESS",
  GET_REG_TYPES_TEMPLATE1_ERROR:
    "GET_REG_TYPES_TEMPLATE1_ERROR",
  GET_REG_TYPES_TEMPLATE1_PENDING:
    "GET_REG_TYPES_TEMPLATE1_PENDING",
  ...
  GET_FIELDS_PERSONAL_INFORMATION_PENDING:
    "GET_FIELDS_PERSONAL_INFORMATION_PENDING",
  GET_FIELDS_REGISTRANT_GUEST_SUCESS:
    "GET_FIELDS_REGISTRANT_GUEST_SUCESS",
  GET_FIELDS_REGISTRANT_GUEST_ERROR:
    "GET_FIELDS_REGISTRANT_GUEST_ERROR",
  GET_FIELDS_REGISTRANT_GUEST_PENDING:
    "GET_FIELDS_REGISTRANT_GUEST_PENDING",  
  RESET_REG_TYPES_TEMPLATE1:
    "RESET_REG_TYPES_TEMPLATE1",
  ...
  GET_ADDITIONAL_REGISTRANTS_LIST_PENDING:
    "GET_ADDITIONAL_REGISTRANTS_LIST_PENDING",
  GET_FIELDS_REGISTRANT_SUCESS:
    "GET_FIELDS_REGISTRANT_SUCESS",
  GET_FIELDS_REGISTRANT_ERROR:
    "GET_FIELDS_REGISTRANT_ERROR",
  GET_FIELDS_REGISTRANT_PENDING:
    "GET_FIELDS_REGISTRANT_PENDING",
  ...
  GET_SESSIONS_TICKETS_DATA_TEMPLATE21_PENDING:
    "GET_SESSIONS_TICKETS_DATA_TEMPLATE21_PENDING",
  GET_REGISTRANTS_INFO_SUCESS:
    "GET_REGISTRANTS_INFO_SUCESS",
  GET_REGISTRANTS_INFO_ERROR:
    "GET_REGISTRANTS_INFO_ERROR",
  GET_REGISTRANTS_INFO_PENDING:
    "GET_REGISTRANTS_INFO_PENDING",
