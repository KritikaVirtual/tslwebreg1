...
const ConfirmationEmail = (props) => {
  ...
  const confirmationEmailResult = (data) => {
    setConfirmationEmail(data)
  };

  useEffect(()=>{
    if(confirmationEmail){
        let result = {}
        result['mConfirmationEmailText'] = confirmationEmail
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  ...
                  backData={(data) => confirmationEmailResult(data)}
                  fetchData={
                    props.confirmationEmail ? props.confirmationEmail : ""
                  }
                />
              </div>
            </div>
