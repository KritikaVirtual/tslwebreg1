...
const ExhibitorsConfirmationPage = (props) => {

  const [exhibitorsConfirmationPage,setExhibitorsConfirmationPage] = useState("")

  const exhibitorsConfirmationPageResult = (data) => {
    setExhibitorsConfirmationPage(data)
  };

  useEffect(()=>{
    if(exhibitorsConfirmationPage){
        let result = {}
        result['mConfirmationPageTextExh'] = exhibitorsConfirmationPage
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Exhibitors Confirmation page"
                  editorCategory={"ExhibitorsConfirmationPage"}
                  editorType={"ExhibitorsConfirmationPage"}
                  backData={(data) => exhibitorsConfirmationPageResult(data)}
                  fetchData={
                    props.exhibitorsConfirmationPage
                      ? props.exhibitorsConfirmationPage
                      : ""
                  }
                />
...
export default ExhibitorsConfirmationPage;
