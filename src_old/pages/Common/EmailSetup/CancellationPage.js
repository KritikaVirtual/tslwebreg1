...
const CancellationPage = (props) => {
  ...
  const [cancellationPage,setCancellationPage] = useState("")

  const cancellationPageResult = (data) => {
    setCancellationPage(data)
  };

  useEffect(()=>{
    if(cancellationPage){
        let result = {}
        result['mCancellationPageText'] = cancellationPage
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Cancellation page"
                  editorCategory={"confirmationEmail"}
                  editorType={"confirmationEmail"}
                  backData={(data) => cancellationPageResult(data)}
                  fetchData={
                    props.cancellationPage ? props.cancellationPage : ""
                  }
                />
              </div>
            </div>
