...
const CancellationEmail = (props) => {

  const [cancellationEmail,setCancellationEmail] = useState("")

  const cancellationEmailResult = (data) => {
  ...
  useEffect(()=>{
    if(cancellationEmail){
        let result = {}
        result['mCancellationEmailText'] = cancellationEmail
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Cancellation Email"
                  editorCategory={"cancellationEmail"}
                  editorType={"cancellationEmail"}
                  backData={(data) => cancellationEmailResult(data)}
                  fetchData={
                    props.cancellationEmail ? props.cancellationEmail : ""
                  }
                />
              </div>
            </div>
