...
const ExhibitorsCancellationPage = (props) => {

  const [exhibitorsCancellationPage,setExhibitorsCancellationPage] = useState("")

  const exhibitorsCancellationPageResult = (data) => {
    setExhibitorsCancellationPage(data)
  };

  useEffect(()=>{
    if(exhibitorsCancellationPage){
        let result = {}
        result['mCancellationPageTextExh'] = exhibitorsCancellationPage
            ...
            <div className="dataTables_length" id="dataTable_length">
              <div className="controls">
                <CommonPageSectionEditor
                  pageTitle="Enter the text you want to show in the Exhibitors Cancellation Page"
                  editorCategory={"ExhibitorsCancellationPage"}
                  editorType={"ExhibitorsCancellationPage"}
                  backData={(data) => exhibitorsCancellationPageResult(data)}
                  fetchData={
                    props.exhibitorsCancellationPage
                      ? props.exhibitorsCancellationPage
                      : ""
                  }
                />
...
export default ExhibitorsCancellationPage;
